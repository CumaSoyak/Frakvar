package farkvar.com.data.remote.network

import android.util.Log
import com.google.gson.Gson
import farkvar.com.data.remote.model.base.BaseMessageResponse
...
class RemoteDataException {
    ...
    private fun getHttpError(body: ResponseBody?) {
        return try {
            ...
            val json = Gson().fromJson(result, BaseMessageResponse::class.java)
